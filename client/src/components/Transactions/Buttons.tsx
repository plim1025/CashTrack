...
const Buttons: React.FC<Props> = props => {
    ...
    return (
        <Wrapper>
            <ButtonWrapper onClick={() => props.showModal()}>
                {'+'}
                <ButtonText>&nbsp;Add</ButtonText>
            </ButtonWrapper>
            <ButtonWrapper variant='secondary' onClick={() => props.handleEditButton()}>
                <ButtonIcon>
            ...
            <ButtonWrapper variant='danger' onClick={() => props.handleDeleteButton()}>
            ...
            <ButtonWrapper variant='success' onClick={() => refresh()}>
